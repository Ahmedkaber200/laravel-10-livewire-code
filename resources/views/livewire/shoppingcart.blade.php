<div>
    ...
    <div class="container">
        ...
        <script>
            window.location.href = "{{ url('/empty-cart') }}";
        </script>
        @else
        <div class="divTable div-hover">
            ...
            <div class="rowTable">
                ...
                <div class="divTableCol"><strong> {{ $item->product->price }}$ </strong></div>
                <div class="divTableCol"><strong> {{ $item->product->price * $item->quantity }}$</strong></div>
                <div class="divTableCol">
                    <button type="button" class="btn btn-danger" wire:click="removeItem({{ $item->id }})"><span class="fa fa-remove"></span> Remove</button>
                </div>
            </div>
            @endforeach
            <br>
            ...
            <div class="rowTable">
                ...
                <div class="divTableCol"></div>
                <div class="divTableCol">
                    <button type="button" class="btn btn-success" wire:click="submit({{ $item->id }})">PROCECCEED TO CHECKOUT</span></button>
                </div>
            </div>
        </div>
    </div>
